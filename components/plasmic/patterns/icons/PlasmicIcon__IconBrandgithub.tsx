...
export type IconBrandgithubIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function IconBrandgithubIcon(props: IconBrandgithubIconProps) {
...
export default IconBrandgithubIcon;
/* prettier-ignore-end */
