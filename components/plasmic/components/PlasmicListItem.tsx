...
import sty from "./PlasmicListItem.module.css"; // plasmic-import: 1QrNyfW0H0c7/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__tlFzQ)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__rwxC)}
              role={"img"}
            />
          ),
